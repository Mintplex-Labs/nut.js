...
import {Region} from "@mintplex-labs/nut-js-shared";
  ...
  describe("screen size", () => {
    ...
    describe("highlight", () => {
      it("should highlight a screen region via libnut", async () => {
        ...
        // THEN
        expect(libnut.screen.highlight).toHaveBeenCalledTimes(1);
        expect(libnut.screen.highlight).toHaveBeenCalledWith(
          x,
          y,
          w,
          h,
